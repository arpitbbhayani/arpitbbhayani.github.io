...
layout: post
seo:
  description: Here is the solution for programming question INVCNT on spoj
  tags:
  - solution
  - source code
  - programming
...
<div class="ui bottom attached tab" data-tab="problem-statement">
    <iframe src="http://www.spoj.com/problems/INVCNT/" width="100%" height="600px" style="overflow: scroll; border: none;"></iframe>
</div>
